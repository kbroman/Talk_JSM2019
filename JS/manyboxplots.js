...
var draw_manyboxplots;

draw_manyboxplots = function(data) {
  var Baxis, BaxisData, Laxis, LaxisData, axisFormat1, axisFormat2, bgcolor, br2, clickStatus, colors, curves, d, darkGray, fix4hist, grp4BkgdHist, h, hist, histColors, histline, i, indRect, indRectGrp, index, j, labelcolor, lightGray, low, lowBaxis, lowBaxisData, lowsvg, lowxScale, lowyScale, maxCount, midQuant, nQuant, pad, quline, randomInd, rightAxis, specialrects, svg, tip, titlecolor, w, xScale, yScale, _i, _j, _k, _l, _len, _len1, _ref, _ref1;
