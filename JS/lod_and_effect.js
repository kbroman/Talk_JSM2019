...
draw_lod_and_effect = function(data) {
  ...
  ref6 = data.chr;
  for (ac = 0, len6 = ref6.length; ac < len6; ac++) {
    j = ref6[ac];
  ...
  dotsAtMarkers = function(chr) {
    var ad, lastMarker, len7, markerCircle, ref7;
    markerClick = {};
    ref7 = data.markers[chr];
    for (ad = 0, len7 = ref7.length; ad < len7; ad++) {
      m = ref7[ad];
      markerClick[m] = 0;
    }
